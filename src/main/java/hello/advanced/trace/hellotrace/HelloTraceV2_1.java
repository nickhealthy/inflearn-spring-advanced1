...
public class HelloTraceV2_1 {
    ...
    //V2에서 추가
    public TraceStatus_1 beginSync(TraceId_1 beforeTraceId, String message) {
        TraceId_1 nextId = beforeTraceId.createNextId();
        long startTimeMs = System.currentTimeMillis();
        log.info("[{}] {}{}", nextId.getId(), addSpace(START_PREFIX, nextId.getLevel()), message);
        return new TraceStatus_1(nextId, startTimeMs, message);
    }
